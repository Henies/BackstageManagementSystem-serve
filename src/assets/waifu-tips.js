...
live2d_settings['aboutPageUrl'] = 'https://pnkx.top/messageboard';   // 关于页地址, '{URL 网址}'
...
const initModel = function initModel(waifuPath, type) {
    ...
    $('.waifu-tool .fui-info-circle').click(function () {
        console.log(router.push({ path: '/messageboard' }))
        // location.replace(live2d_settings.aboutPageUrl);
    });
